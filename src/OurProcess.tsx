...
const OurProcess = (props: Props) => {
	return (
		<Grid justify="flex-start">
			<Grid.Col span={6} style={{ maxWidth: 360 }} visibleFrom="xs">
				<Image src={PRC} alt="prc" w={607} h={696} left={0} />
			</Grid.Col>

			<Grid.Col span={6} style={{ maxWidth: 360 }} visibleFrom="xs" ml={123}>
				<Text size="32px" w={374} h={102} fw={600} mt={123} style={{ lineHeight: "51.2px" }}>
					Our Process
				</Text>
				<Text w={502} style={{ color: "#555459" }} size="sm" fw={"bold"}>
					Our systems and instruments are developed and designed by a team of skilled engineers, who
					hold expertise in their respective field. We offer our clients with modernized development
					and design services for both software and hardware.
				</Text>
				<br />
				...
				<UnstyledButton pt={64}>
					<Text fz={20} fw={"bold"} hiddenFrom="xs">
						Know More
					</Text>
				</UnstyledButton>
			</Grid.Col>
