		...
		<Paper w={1440} h={4035}>
			<Grid>
				<Grid.Col span={6}>
					...
					>
						...
						and Scanners, Temperature, Humidity Sensors and Transmitters.
						<br />
						<br />
						We also have Indicators, and Controllers, Clean Room Monitoring Systems for Environment,
						Cold Storage, Data Centre, Server Room, Greenhouse, Warehouse to measure Temperature,
						Humidity, and Differential Pressure. <br />
						<br />
						Thyristor Triggering Cards, Thyristor Power Controllers, Signal Converters/Conditioners
						and Isolators, Molten Metal Pyrometers, DC Motor Controllers, Motor Soft Starters, IoT
						Modules, Instrumentation Control Panels, Data Acquisition Software, Customized
						Instruments, and many more services.
					</Text>
				</Grid.Col>
				<Grid.Col span={6}>
			...
			<Paper w={1440} h={625} mt={65}>
				<Grid gutter="lg">
					...
					<Grid.Col span={6}>
						<Text fz={32} h={44} fw={600} mt={134} style={{ color: "#292929" }}>
							Digital Indicators
						</Text>
						<Text
							h={110}
			...
			<Grid gutter="lg">
				<Grid.Col span={6}>
					...
					<Text w={595} style={{ color: "#555459" }} fz={14} fw={400} mb={40} ml={114} mt={32}>
						...
						aluminum/copper bus bars, semiconductor fuses and thermal cutouts.
						<br />
						<br />
			...
			<Grid gutter="lg" mt={222}>
				<Grid.Col span={6}>
					<Image src={BluerectangleBg} alt="Vision" h={625} w={505} pos="absolute" pl={0} ml={0} />
					<Image
						src={DigitalClock}
						alt="Vision"
						w={543}
				...
				<Grid.Col span={6}>
					<Text fz={32} w={596} h={44} fw={600} mr={114} mt={134} style={{ color: "#292929" }}>
						Digital Indicators
					</Text>
					<Text
						h={110}
					...
					>
						...
						<br />
						You’ll probably recognise some of the classic profiles when browsing our wide range.
						Whether you’re looking to add style to your workspace with a modern office desk lamp, a
						small desk lamp for tight spaces or, a reading lamp for an ambient study glow, you’ll
						find the right table and desk lamp for you.
					</Text>
					<UnstyledButton>
						<Group>
			...
			<Grid gutter="lg" mt={150}>
				<Grid.Col span={6} mt={137}>
					<Box>
						<Text fz={32} w={558} h={102} fw={600} pt={105} ml={114} style={{ color: "#292929" }}>
							Humidity Instruments
						</Text>
					</Box>
					<Text w={595} ml={114} style={{ color: "#555459" }} fz={14} fw={400} mb={40} pt={85}>
						Experts in lighting, we’ve been creating task lights, desk lamps and table lamps for
						over 80 years. All our lamps uphold the original Anglepoise design concept whilst
						incorporating essential modern features. You’ll probably recognise some of the classic
						profiles when browsing our wide range.
			...
			<Grid gutter="lg" mt={220}>
				...
				<Grid.Col span={6}>
					...
					<Text h={110} w={596} style={{ color: "#555459" }} fz={14} fw={400} mb={40} mt={24}>
						Experts in lighting, we’ve been creating task lights, desk lamps and table lamps for
						over 80 years. All our lamps uphold the original Anglepoise design concept whilst
						incorporating essential modern features. You’ll probably recognise some of the classic
						profiles when browsing our wide range.
