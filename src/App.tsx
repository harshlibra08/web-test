	...
	return (
		...
		>
				...
				<BackgroundImage src={BGImage} h={600} w={1441} pos="absolute">
					...
					<Center>
						<Text color="#F6F6F6" size="14px" weight={400} h={66} w={1014} align="center">
							We offer complete solutions for accurate measurement and control of Humidity,
							Pressure, Flow, Level, pH, Speed, etc. Our products are reliable and excellent in
							quality and are conforming to EN61010 International Safety Standards.
						</Text>
					</Center>
					...
					<Card h={700} w={391}>
						<Card.Section>
							...
							<Text
								...
								color="#000000"
							>
								While designing and manufacturing our products, we sustain a way in which our
					...
					<Grid gutter="lg">
						...
						<Col span={6}>
							...
							<Text h={44} w={592} color="#555459" size={16} weight={400}>
								Our systems and instruments are developed and designed by a team of skilled
								engineers, who hold expertise in their respective field. We offer our clients with
								modernized development and design services for both software and hardware.
								<br />
								<br />
								<br />
								...
								reliability, sturdy construction and long service life. We are currently supported
								by 1,50,000 instruments, enabling us with an outstanding range of output.
							</Text>
						</Col>
					</Grid>
				</Container>
					...
					<Grid gutter="lg">
						...
						<Col span={6}>
							...
							<Text h={44} w={596} color="#FFFFFF" size={16} weight={400}>
								...
								associates. The legacy of our vision will continue, in spite of reaching the
								pinnacle of our growth and change of generation. We will be committed to doing the
					...
					<Grid gutter="380px">
						<Col span={6}>
							...
							>
								...
								Chambers, Petroleum Industries, Steel Industries, Textile Industries, BOD
								Incubators, HVAC Industries, AHU Industries, APFC Industries, Packaging Industries,
								Automation Industries, Plastic Industries, Food Industries, Pollution Control
								Industries, Petrochemical Industries, Water Treatment Plants, Research and Defence
								Institutes.
							</Text>
						</Col>
					...
					<Grid gutter="lg">
						...
						<Col span={6}>
							...
							>
								...
								rugged and reliable Electronic Process Control Instruments, using the latest
								available and accessible technology for the long lasting and trouble-free field
								performance. While designing and manufacturing our products, we will sustain the way
					...
					<Grid gutter="lg">
						<Col span={6}>
							...
							>
								...
								microprocessors and digital-based electronic process control instruments. Our
								product range includes Temperature and Process Indicators, Large/Jumbo Display
								Indicators, Portable Thermometers, Process Controllers such as On-Off Controllers,
								PID Controllers, Ramp/Soak Controllers, and Multi Zone Controllers, Temperature and
								...
								Environment, Cold Storage, Data Centre, Server Room, Greenhouse, Warehouse to
								measure Temperature, Humidity, and Differential Pressure. <br />
								<br />
								Thyristor Triggering Cards, Thyristor Power Controllers, Signal
								Converters/Conditioners and Isolators, Molten Metal Pyrometers, DC Motor
								Controllers, Motor Soft Starters, IoT Modules, Instrumentation Control Panels, Data
					...
					<Grid gutter="lg">
						<Col span={6}>
							...
							>
								...
								LTC-15 or LTC-18, suitably rated back to back connected SCR Modules (with
								electrically isolated base, mounted on the heat sink, input and output clip-on type
								heavy-duty connectors or aluminum/copper bus bars, semiconductor fuses and thermal
								cutouts.
								<br />
								<br />
								The entire assembly is mounted on an MS powder-coated enclosure, which in turn can
								be easily mounted inside the closed control panel as desired.
							</Text>
							<UnstyledButton>
			...
			<Paper w={1440} h={6097} withBorder bg={"black"}>
				...
				<Container>
					...
					<Text color="#E4E8ED" align="left" size={16} pt={34} w={1000} weight="normal">
						Welding is the process of joining metals or thermoplastics by using high heat or
						pressure and fusing the parent material with weld metal. Welding has many applications
						in industries like automotive, shipping, construction, mechanical, and many more. The
						major drawback of welding is the residual stress formed by the rapid cooling of the weld
						material. The sudden shrinking of the joint material weakens the equipment, thus
						impacting the metal's quality and structure. For dense materials, these stresses can
						even exceed the specified design stress. <br />
						...
						mechanical strength. This treatment can be performed after any welding process, but it
						has a specific meaning for few industries. Current design codes such as ASME and BSI
						Pressure vessels and Piping codes specify that PWHT is required to ensure safe and
					...
					<Text color="#E4E8ED" align="left" size={16} pt={34} w={1000} weight="normal" mb={128}>
						...
						can form cracks in the component. Heating and cooling rate, holding temperature, and
						soak duration must be controlled and monitored precisely to avoid any detrimental
						effects such as reheat cracking, distortion, decrease in the toughness, and over
						softening to obtain the full benefit of the process. <br /> <br />
						Libratherm offers Single-Zone and Multi-Zone PID Ramp Soak controllers, which precisely
						controls the PWHT process. They can directly accept grounded/ungrounded thermocouples
						and provide analogue/SSR output with PID control action. The user can program multiple
						steps of ramping, soaking, and cooling to achieve a precise heating rate. Both
						controllers can operate independently or in a cascade mode (Master-Slave). Optionally
						MODBUS over RS-485 interface is also available for interfacing with SCADA, PLC or data
						logging systems.
					</Text>
				</Container>
						...
						<Col span={6}>
							...
							<Container>
								...
								<Text h={110} w={596} color="#E4E8ED" size={16} weight={400} ml={-200} mt={98}>
									Libratherm offers Ramp/Soak Programmable PID Temperature Controller – PRC-489
									which is designed to improve reliability, accuracy, and control for all
									temperature control applications. It features Ramp and Soak functions. The single
									pattern of a total of 16 (ramp/soak) steps can be programmed and stored in the
									memory. It can also be used as single set point control when the ramp/soak profile
									control is not desired. The controllers are calibrated for a K-type thermocouple.
								</Text>
							...
							<Stack>
								<Box w="100%">
									...
									<Text size={"16px"} ml={123} mt={22} w={488} color="#E4E8ED">
										401-403, Diamond Industrial Estate, Ketkipada Road, Dahisar (East), Mumbai
			...
			<Paper bg={"black"} w={1440} h={439} withBorder mt={50}>
				<Box>
					<Text align="center" color="#F6F6F6" size={16} weight={600} mt={103}>
						WORK WITH US
					</Text>
					<Text align="center" color="#F6F6F6" size={32} weight={600} mt={18}>
						Professionally
					</Text>
					<Text align="justify" color="#E4E8ED" size={16} weight={400} mt={18} w={1006} ml={217}>
			...
			<Paper w={1440} h={914} withBorder>
				<Grid ml={264} mt={90}>
					<Grid.Col span={6}>
						<Stack>
							<Text color="#262728" size={24} weight={600}>
								Embedded Software Engineer
							</Text>
							<Text color="#555459" size={16} weight={400}>
							...
							<UnstyledButton>
								<Text color="#292929" size={20} weight={400}>
									Apply Now
								</Text>
							</UnstyledButton>
						</Stack>
					...
					<Group ml={119} mt={48}>
						<Stack>
							<Box w="100%">
								...
								<Text color="#E4E8ED" size={18} weight={600} ml={119} mt={35}>
									Qualifications
								</Text>
								<List mt={35} ml={119} w={440}>
									<List.Item
						...
						<Stack ml={109} mt={-470}>
							...
							<Stack align="flex-end">
								<PrimaryButton w={138}>
									{" "}
									<Text color="#262728" size={15} weight={700}>
										SEND
									</Text>
								</PrimaryButton>
							</Stack>
